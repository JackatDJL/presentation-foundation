...
export default function Home({
      ...
      return (
        <div className="container mx-auto px-4 py-12">
          <div className="text-center">
            ...
            <p className="mb-6">The presentation with shortname "{shortname}" could not be found.</p>
            <Link
              href="/"
  ...
  const publicPresentations = presentations.filter((p) => p.visibility === "public")

  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold mb-8 text-center">Presentation Foundation</h1>
      <p className="text-center mb-12 max-w-2xl mx-auto">
        Share your presentations, handouts, and research materials without the need for cloud storage logins.
      </p>
